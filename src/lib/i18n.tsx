...
const PT: Record<string, string> = {
  ...
  "Customise and save up to {n} presets. Drag to move and scroll to resize.": "Personalize e salve até {n} pré-definições. Arraste para mover e use o scroll para redimensionar.",
  "Elements": "Elementos",
  "Upload a photo and set the texts.": "Envie foto e defina os textos.",
  "Profile photo": "Foto de perfil",
  "Replace": "Trocar",
  "Upload": "Enviar",
  "e.g. Movies I love": "Ex: Filmes que amo",
  "Username (@)": "Usuário (@)",
  "Name colour": "Cor do nome",
  "@ colour": "Cor do @",
  "Text alignment": "Alinhamento do texto",
  "Align": "Alinhar",
  "Show the blue badge next to the name": "Mostrar selo azul ao lado do nome",
  "Text size": "Tamanho do texto",
  "Photo size": "Tamanho da foto",
  "Drag to move • Scroll to resize": "Arraste para mover • Scroll para redimensionar",
  "Download .png": "Baixar .png",
  "Save to my account": "Salvar no sistema",
  ...
  "e.g. Cinema profile": "Ex: Perfil cinema",
  "This name shows up in the saved overlays list inside the editor.": "Esse nome aparece na lista de overlays salvos dentro do editor.",
  "Rename profile": "Renomear perfil",
  "Delete profile": "Excluir perfil",
  "We could not save the profile to your account.": "Não foi possível salvar o perfil na sua conta.",
  "We could not rename the profile.": "Não foi possível renomear o perfil.",
  "Saved as": "Salvo como",
  "loaded": "carregado",
  // header / shell
  ...
  "Credits used / credits available": "Créditos utilizados / créditos disponíveis",
  "Hide link": "Ocultar link",
  ...
  "Everyone": "Todos",
  "Apply to all users": "Aplicar a todos os usuários",
  "Specific users": "Usuários específicos",
  "Pick the accounts that will receive these settings.": "Selecione as contas que receberão estas configurações.",
  "Apply to selected": "Aplicar aos selecionados",
  "Pick at least one account.": "Selecione pelo menos uma conta.",
  "{n} account(s) selected": "{n} conta(s) selecionada(s)",
  "{n} account(s) updated.": "{n} conta(s) atualizada(s).",
